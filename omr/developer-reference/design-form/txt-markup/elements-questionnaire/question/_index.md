...
**color** | black | Color of question and answer texts. Can be picked from one of the [supported](/omr/supported-colors/) values. | `color=red`
...
**color** | black | Color of the answer's texts. Can be picked from one of the [supported](/omr/supported-colors/) values. | `color=red`
